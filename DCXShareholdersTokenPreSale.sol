...
import "./DCXShareholdersToken.sol";

contract DCXShareholdersTokenPreSale {
    DCXShareholdersToken public token;
    ...
    function DCXShareholdersTokenPreSale(
        DCXShareholdersToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = DCXShareholdersToken(_token);
